...
<ul class="navbar nav ">
 ...
 <div id="flex">
		...
		<form method="post" enctype="multipart/form-data" action="database/add_emp.php">
		<table border="1" id="t2" height="200px" width="60%">
		...
		<input type="submit"  class="btn btn-danger" value="submit" id="b2" name="submit">
