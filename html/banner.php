...
<ul class="navbar nav ">
  ...
  <div id="flex" class="well">
		...
		<form method="post" enctype="multipart/form-data" action="database/banner.php">
		<table border="0" id="t6">
		<tr><td><b class="heading">Banner Image</b></td></tr>
		<tr>
		...
		<tr><td align="center" ><input type="submit" class="btn btn-danger btn-lg" id="add2" value="update" name="update"></td></tr>
		<tr><td>
		...
		{   
			...
			if($mes1==1)
	        echo "<h4>bannner updated</h4>";
		else
			 echo "<h4>something went worng!</h4>";
		}
		?>
			</td></tr>
		</table>
