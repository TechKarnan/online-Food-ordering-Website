...
<ul class="navbar nav ">
 ...
 <div id="flex">
		...
		<thead>
		<tr><thcolspan="3"><center><b class="heading">Employees dilivery status</b></center></th></tr>
...
?>
       ...
       $res=$con->query($sql);
		...
		<form action='database/eupdate.php' method='post'> 
		
		
		<td>
		<select id='sorder' name='start'>
		<option>delivered</option>
		<option>not_delivered</option>
